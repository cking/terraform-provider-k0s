module github.com/cking/opentofu-provider-k0s
...
require (
	...
	github.com/k0sproject/k0sctl v0.28.0
	github.com/k0sproject/rig v0.21.1
...
require (
	...
	github.com/k0sproject/bootloose v0.9.6 // indirect
